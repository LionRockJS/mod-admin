...
export default class ControllerAdmin extends Controller {
  ...
  constructor(request: any, model: any, options: any = {}) {
    ...
    this.options.databases.forEach((v: any, k: any) => databaseMap.set(k, v));
    ...
    this.options.templates.forEach((v: any, k: any) => templates.set(k, v));
