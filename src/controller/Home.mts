import { ControllerMixinViewData, ControllerMixinDatabase, ORM, Central, ControllerMixinView} from '@lionrockjs/central';
...
export default class ControllerHome extends Controller{
  ...
  async action_index() {
    ...
    const usercount = await (ORM as any).countAll(User, { database});
